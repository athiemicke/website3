...
#Kona  	geo:19.65,-155.994167
#WCM  	geo:40.76455,-73.954147

sites <- data.frame(longitude = c(11.586111, 10.733333,-122.272778,-79.976389,-86.783333,-73.467222,-117.823056,-86.808889,-155.994167,
                                  -73.954147
                                
                                   ), latitude = c(50.927222, 59.916667,37.871667,40.439722,36.166667,40.861944,
                                                                  33.669444,  33.653333,19.65,40.76455),
                    purpose= c('Education', 'Education', 'Research', 'Research', 'Education', 'Presentation',
                               'Presentation', 'Presentation', 'Presentation', 'Research'),
                    Institution=c('Friedrich-Schiller-University Jena','University of Oslo','UC Berkeley',
                                  ...
                                  'UC Irvine','UA Birmingham','Hawaii','Weill-Cornell Medicine'),
                    explanation=c('Bachelor of Science 2008-2011\nMaster of Science 2011-2014', 
                                  ...
                                  'w-qbio 2020', 'Postdoctoral Fellow 2020-present'
                                  )
...
CV_Map <- ggplot(data = world) +
  ...
  #            shape = 23) +
  coord_sf(xlim = c(-160, 28), ylim = c(18, 73), expand = FALSE)+
  theme(
