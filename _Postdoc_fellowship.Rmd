...
'Awards(2019)'=c(51,30,27,20,NA,NA,9,255,12,19,
...
'Deadline'=c(07/01,02/03,10/01,08/15,07/20,
             08/21,06/12,08/15,07/02,10/01,
             01/08,11/16,07/15,12/02,10/01,
             11/12,05/26,06/20,12/01,01/15,
             03/04,'2021','2021','2021','2021','2021','2021','2021','2021'),
'LOI'=c(05/15,NA,NA,NA,05/05,
        08/14,NA,NA,NA,NA,
        NA,NA,NA,NA,NA,
        NA,NA,01/03,11/01,
        NA),
...
fellow3 <- fellow2[1:4]
fellow3 %>% 
  mutate(Fellowship = cell_spec(fellow2$Fellowship, "html", link = fellow2$truelink)) %>%
