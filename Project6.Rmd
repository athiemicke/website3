...
A coronavirus causing a disease called COVID-19 has affects the world since 2020. The infection spread globally and was declared a pandemic.
...
p15 <- ggplot(rel_death_mobility, aes(x = date, y = value, color=group))+
  ...
  scale_y_continuous(breaks = seq(0,120,50))+
